...
public class King extends Piece {
    ...
    public King(PieceColor pieceColor, Cell cell) {
    ...
    private boolean isValidMove(int coordinateX, int coordinateY, int currentX, int currentY) {
        if (coordinateX == currentX - 1 && coordinateY == currentY) {
            return true;
        } else if (coordinateX == currentX + 1 && coordinateY == currentY) {
            return true;
        } else if (coordinateX == currentX && coordinateY == currentY - 1) {
            return true;
        } else if (coordinateX == currentX && coordinateY == currentY + 1) {
            return true;
        } else if (coordinateX == currentX - 1 && coordinateY == currentY + 1) {
            return true;
        } else if (coordinateX == currentX - 1 && coordinateY == currentY - 1) {
            return true;
        } else if (coordinateX == currentX + 1 && coordinateY == currentY - 1) {
